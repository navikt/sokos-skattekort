...
3. Lag SQL. Ved go-live fikk vi en fil som inneholdt personnummer som de første 11 tegnene per linje. Dette skriptet vil lage SQL som fungerer:
   ...
   ```
4. Kjør denne SQL-en mot databasen. Ikke gjør det med en lokal klient, men bruk import-knappen på https://console.cloud.google.com/sql/instances/sokos-skattekort/overview?project=okonomi-prod-7c4c . Husk å velge din egen bruker.
5. Vent til importen har kjørt ferdig, slå så på featureswitch for lesing av forespoersel_input: https://okonomi-unleash-web.iap.nav.cloud.nais.io/projects/default/features/sokos-skattekort.forespoerselinput.enabled
6. Vent til alle radene har blitt lest fra forespoersel_input, slå av feature switch igjen.
7. Slett bøtta SQL-fila ligger i hos Google
8. Slett import-filene fra lokal arbeidsstasjon
9. Slett import-filene fra eventuelle andre lagringsplasser
