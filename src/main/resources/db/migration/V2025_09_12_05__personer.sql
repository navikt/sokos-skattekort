...
CREATE INDEX IF NOT EXISTS abonnement_aar_fnr ON abonnementer (aar, person_id);
...
(
    ...
    fnr                 TEXT                                                 NOT NULL,
    aar                 SMALLINT                                             NOT NULL,
    bestilling_batch_id BIGINT REFERENCES bestillingsbatcher (id) DEFERRABLE NULL,
    oppdatert           TIMESTAMPTZ DEFAULT now()
);
